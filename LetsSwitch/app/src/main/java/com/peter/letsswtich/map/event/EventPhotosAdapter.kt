...
class EventPhotoAdapter(val viewModel: EditEventViewModel) :
    ListAdapter<String, EventPhotoAdapter.ViewHolder>(DiffCallback) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            if (getItem(position) != "") {
                ...
                Log.d(
                    "EditPhotoAdapter",
                    "value of click list before = ${viewModel.photoList.value}"
                )
                ...
                Log.d(
                    "EditPhotoAdapter",
                    "value of click list After = ${viewModel.photoList.value}"
                )
            } else {
